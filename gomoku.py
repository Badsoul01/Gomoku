...
class HumanPlayer(Player):
    ...
    def get_move(self, board):
        ...
        while True:
            souradnice_x =input(f"Zadej číslo 1-{board.size:}(pro řádek): ")
            souradnice_y = input(f"Zadej číslo 1-{board.size}(pro sloupec): ")
            if souradnice_x == "quit" or souradnice_y == "quit":
                break
            try:
